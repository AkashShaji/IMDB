...
public class GraphPartialTester {
	...
	public void setUp () throws IOException {
		actorsGraph = new IMDBActorsGraph("IMDB/actors_test.list", "IMDB/actresses_test.list");
		moviesGraph = new IMDBMoviesGraph("IMDB/actors_test.list", "IMDB/actresses_test.list");
